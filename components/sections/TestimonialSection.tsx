        ...
        <section className="bg-primary px-8 md:px-[5rem] py-[5.19rem] rounded-large mt-16">
            <div>
                <p className="font-[600] text-[1.5rem]">
                    &apos;&apos;Wallet is a great product! All of my most
                    important information is there - credit cards, transit
                    cards, boarding passes, tickets, and more. And I don&apos;t
                    need to worry because it&apos;s all in one place!
                    thanks!&apos;&apos;
                </p>
            </div>
            <div className="flex gap-4 items-center gap-[1.25rem] mt-[3.13rem]">
                ...
                <div>
                    <p className="text-[#2B2B2B] opacity-[0.4] pb-1">
                        Johnny Owens
                    </p>
